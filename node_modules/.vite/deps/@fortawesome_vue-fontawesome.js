import { U as computed, gn as watch, nt as defineComponent, pt as h$1 } from "./vue.runtime.esm-bundler-D4M2X7UN.js";
...
var it = ["kit"];
_defineProperty$1(_defineProperty$1({}, "kit", "Kit"), "kit-duotone", "Kit Duotone");
var mt = {
	kit: { "fa-kit": "fak" },
...
_jl = {}, _defineProperty$1(_defineProperty$1(_defineProperty$1(_defineProperty$1(_defineProperty$1(_defineProperty$1(_defineProperty$1(_defineProperty$1(_defineProperty$1(_defineProperty$1(_jl, "classic", "Classic"), "duotone", "Duotone"), "sharp", "Sharp"), "sharp-duotone", "Sharp Duotone"), "chisel", "Chisel"), "etch", "Etch"), "graphite", "Graphite"), "jelly", "Jelly"), "jelly-duo", "Jelly Duo"), "jelly-fill", "Jelly Fill"), _defineProperty$1(_defineProperty$1(_defineProperty$1(_defineProperty$1(_defineProperty$1(_defineProperty$1(_defineProperty$1(_defineProperty$1(_defineProperty$1(_defineProperty$1(_jl, "mosaic", "Mosaic"), "notdog", "Notdog"), "notdog-duo", "Notdog Duo"), "pixel", "Pixel"), "slab", "Slab"), "slab-duo", "Slab Duo"), "slab-press", "Slab Press"), "slab-press-duo", "Slab Press Duo"), "thumbprint", "Thumbprint"), "utility", "Utility"), _defineProperty$1(_defineProperty$1(_defineProperty$1(_defineProperty$1(_jl, "utility-duo", "Utility Duo"), "utility-fill", "Utility Fill"), "vellum", "Vellum"), "whiteboard", "Whiteboard");
_defineProperty$1(_defineProperty$1({}, "kit", "Kit"), "kit-duotone", "Kit Duotone");
var ra = {
	classic: {
		"fa-brands": "fab",
...
var ga = [].concat(_toConsumableArray$1(Object.keys(al$1)), el$1, [
	"aw",
	"fw",
	"pull-left",
	"pull-right"
...
_PREFIX_TO_STYLE[u] = _objectSpread2$1(_objectSpread2$1(_objectSpread2$1(_objectSpread2$1({}, { "fa-duotone": "duotone" }), rl[u]), rt["kit"]), rt["kit-duotone"]);
var PREFIX_TO_STYLE = familyProxy(_PREFIX_TO_STYLE);
var _STYLE_TO_PREFIX = _objectSpread2$1({}, $l);
_STYLE_TO_PREFIX[u] = _objectSpread2$1(_objectSpread2$1(_objectSpread2$1(_objectSpread2$1({}, { duotone: "fad" }), _STYLE_TO_PREFIX[u]), St["kit"]), St["kit-duotone"]);
...
familyProxy(_objectSpread2$1({}, Al));
...
function getCanonicalIcon(values) {
	...
	var canonical = _objectSpread2$1(_objectSpread2$1({}, moveNonFaClassesToRest(nonStyleOrFamilyClasses)), {}, { prefix: getCanonicalPrefix(styleFromValues, { family }) });
...
function registerPlugins(nextPlugins, _ref) {
	...
	_plugins.forEach(function(plugin) {
		...
		Object.keys(mixout).forEach(function(tk) {
			...
			if (_typeof$1(mixout[tk]) === "object") Object.keys(mixout[tk]).forEach(function(sk) {
				if (!obj[tk]) obj[tk] = {};
...
var api = {
	...
	parse: { icon: function icon(_icon) {
		...
		if (_typeof$1(_icon) === "object" && _icon.prefix && _icon.iconName) return {
			prefix: _icon.prefix,
...
function makeLayersTextAbstract(params) {
	...
	var attributes = _objectSpread2$1(_objectSpread2$1({}, extra.attributes), {}, { class: extra.classes.join(" ") });
...
var render = function render(iconDefinition) {
	...
	return domVariants(_objectSpread2$1({ type: "icon" }, iconDefinition), function() {
...
var Layers = { mixout: function mixout() {
	return { layer: function layer(assembler) {
		...
		return domVariants({ type: "layer" }, function() {
			...
			return [{
				tag: "span",
				attributes: { class: ["".concat(config.cssPrefix, "-layers")].concat(_toConsumableArray$1(classes)).join(" ") },
				children
			}];
		});
	} };
...
function hexValueFromContent(content) {
	return toHex(_toConsumableArray$1(content.replace(CLEAN_CONTENT_PATTERN, ""))[0] || "");
}
...
registerPlugins([
	...
	{ provides: function provides(providers) {
		...
		providers.missingIconAbstract = function() {
			...
			var OPACITY_ANIMATE = _objectSpread2$1(_objectSpread2$1({}, ANIMATION_BASE), {}, { attributeName: "opacity" });
			var dot = {
				tag: "circle",
...
function createGradientStop(stop, index) {
	return h$1("stop", _objectSpread2({
		"key": "".concat(index, "-").concat(stop.offset),
		"offset": stop.offset,
		"stop-color": stop.color
	}, stop.opacity !== void 0 && { "stop-opacity": stop.opacity }));
}
/**
...
function stripFillsFromPaths(abstractElement) {
	...
	if (abstractElement.tag === "path" && abstractElement.attributes && "fill" in abstractElement.attributes) return _objectSpread2(_objectSpread2({}, abstractElement), {}, {
		attributes: _objectSpread2(_objectSpread2({}, abstractElement.attributes), {}, { fill: void 0 }),
		children
	});
	return _objectSpread2(_objectSpread2({}, abstractElement), {}, { children });
}
/**
...
function convert(abstractElement) {
	...
	var element = !!gradientFill || "fill" in attrs ? stripFillsFromPaths(abstractElement) : abstractElement;
	...
	if (gradientFill && gradientFill.id && (gradientFill.type === "linear" || gradientFill.type === "radial")) {
		...
		var gradientVNode = h$1(gradientType === "linear" ? "linearGradient" : "radialGradient", _objectSpread2(_objectSpread2({}, gradientProps), {}, { id }), stops.map(createGradientStop));
		return h$1(element.tag, _objectSpread2(_objectSpread2(_objectSpread2(_objectSpread2({}, renderProps), {}, {
			class: mixins.class,
			style: _objectSpread2(_objectSpread2({}, mixins.style), aStyle)
		}, mixins.attrs), otherAttrs), {}, { fill: "url(#".concat(id, ")") }), [gradientVNode].concat(_toConsumableArray(children)));
	}
	return h$1(abstractElement.tag, _objectSpread2(_objectSpread2(_objectSpread2({}, renderProps), {}, {
		class: mixins.class,
		style: _objectSpread2(_objectSpread2({}, mixins.style), aStyle)
...
var FontAwesomeIcon = defineComponent({
	...
	setup: function setup(props, _ref) {
		...
		if (props.gradientFill && props.symbol) log("gradientFill is not supported when symbol is true and will be ignored");
		var vnode = computed(function() {
			return renderedIcon.value ? convert(renderedIcon.value.abstract[0], { gradientFill: props.symbol ? null : props.gradientFill }, attrs) : null;
		});
		return function() {
			return vnode.value;
		};
