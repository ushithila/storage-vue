import { config as config$1, icon, parse as parse$1, text } from "./@fortawesome_fontawesome-svg-core.js";
import { U as computed, gn as watch, nt as defineComponent, pt as h } from "./vue.runtime.esm-bundler-D4M2X7UN.js";
...
function convert(abstractElement) {
	...
	if (gradientFill && gradientFill.id && (gradientFill.type === "linear" || gradientFill.type === "radial")) {
		...
		var gradientVNode = h(gradientType === "linear" ? "linearGradient" : "radialGradient", _objectSpread2(_objectSpread2({}, gradientProps), {}, { id }), stops.map(createGradientStop));
