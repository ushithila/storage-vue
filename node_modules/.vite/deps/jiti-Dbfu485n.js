...
import { a as require_browser_external_node_module, i as require_browser_external_node_fs, n as require_browser_external_node_util, r as require_browser_external_node_url, t as require_browser_external_node_os } from "./browser-external_node_os-66ycnBu8.js";
import { t as require_browser_external_node_path } from "./browser-external_node_path-uh2Zjz-d.js";
import { t as require_promises } from "./promises-DoqYZXrG.js";
import { i as require_browser_external_node_perf_hooks, n as require_browser_external_node_assert, r as require_browser_external_node_crypto, t as require_browser_external_node_v8 } from "./browser-external_node_v8-DfXlXWCm.js";
import { n as require_browser_external_node_process, t as require_browser_external_node_tty } from "./browser-external_node_tty-CiIP1Kvl.js";
...
var require_jiti = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	(() => {
		var e = {
			...
			fs(e) {
				"use strict";
				e.exports = require_browser_external_fs();
			},
			"node:fs"(e) {
				"use strict";
				e.exports = require_browser_external_node_fs();
			},
			"node:module"(e) {
				"use strict";
				e.exports = require_browser_external_node_module();
			},
			"node:path"(e) {
				"use strict";
				e.exports = require_browser_external_node_path();
			},
			os(e) {
				"use strict";
				e.exports = require_browser_external_os();
			},
			path(e) {
				"use strict";
				e.exports = require_browser_external_path();
			},
		...
		(() => {
			...
			}, Qe = require_browser_external_node_url(), Ze = require_browser_external_node_assert(), Xe = require_browser_external_node_process();
			var et = __webpack_require__("node:path");
			const tt = require_browser_external_node_v8(), it = require_browser_external_node_util(), st = new Set(Be.builtinModules);
			...
			var Gt = { rE: "2.6.1" };
			const Kt = require_browser_external_node_crypto();
			...
			const di = require_browser_external_node_tty()?.WriteStream?.prototype?.hasColors?.() ?? !1, base_format = (e, t) => {
				if (!di) return (e) => e;
				const i = `[${e}m`, n = `[${t}m`;
				return (e) => {
					const a = e + "";
			...
			const wi = require_promises(), Ci = require_browser_external_node_perf_hooks(), Si = require_browser_external_node_vm();
